...
- The renderer dev server runs at `http://localhost:5173/`; the app connects to the backend at `https://xensemble.dev` by default or `http://localhost:3000` for local dev.
