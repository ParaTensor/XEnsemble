        ...
        <div className="flex min-w-0 items-center gap-3 text-xs">
          <div className="flex items-center gap-1.5 text-[#202124]">
            ...
            <button
              ...
              title="Switch branch"
              className={`flex items-center gap-1 max-w-[12rem] truncate font-mono font-medium hover:text-[#5F6368] transition-colors`}
            >
              {operation === 'switch' ? (
          ...
          <div className="border-t border-[#E8EAED] mt-1 pt-1 px-2 pb-1">
            <div className="flex items-center gap-1">
              ...
              <button
                ...
                title="Create branch"
                className={`shrink-0 p-1 rounded text-[#5F6368] hover:text-[#202124] hover:bg-[#E8EAED] disabled:opacity-40 disabled:cursor-default`}
              >
                {operation === 'switch' ? (
                  <Loader2 className="h-3.5 w-3.5 animate-spin" />
                ) : (
