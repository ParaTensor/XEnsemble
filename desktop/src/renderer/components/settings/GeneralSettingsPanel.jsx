        ...
        <div className="flex-1 min-h-0 space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="text-xs text-[#5F6368]">Workspaces</label>
                <Input
                  type="number"
                  min={0}
              ...
              <div>
                <label className="text-xs text-[#5F6368]">Sessions</label>
                <Input
                  type="number"
                  min={0}
              ...
              <div>
                <label className="text-xs text-[#5F6368]">Previews</label>
                <Input
                  type="number"
                  min={0}
              ...
              <div>
                <label className="text-xs text-[#5F6368]">Tier</label>
                <SelectMenu
