  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        {agentsLoading ? (
          <p className="text-sm text-[#5F6368] h-9 flex items-center">Loading agents...</p>
        ) : agents.length === 0 ? (
          <p className="text-sm text-[#5F6368]">No agents available.</p>
        ) : (
          <SelectMenu
      ...
      {loading || agentsLoading ? (
        ...
        <p className="text-sm text-[#5F6368]">Select an agent.</p>
      ) : (
