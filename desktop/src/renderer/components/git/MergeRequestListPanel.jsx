...
export default function MergeRequestListPanel({ projectId, provider }) {
          ...
          <table className={`w-full text-left ${consoleTableShellClass}`}>
            ...
            <tbody className={consoleTableBodyDivideClass}>
              {mergeRequests.map((mr) => (
                <tr key={mr.id} className={consoleTableBodyRowClass}>
                  ...
                  <td className={`${consoleTableBodyCellDenseClass} min-w-0`}>
                    <span className="block truncate max-w-[12rem]" title={mr.title}>
                      {mr.title}
                    </span>
                  </td>
                  <td className={consoleTableBodyCellDenseClass}>
                  ...
                  <td className={consoleTableBodyCellDenseClass}>
                    <span className="block truncate max-w-[8rem]" title={mr.source_branch || mr.sourceBranch}>
