/** Console tokens — Morandi light theme layer. */
...
/** @deprecated Use getTerminalTheme() via useTerminalTheme — kept for legacy imports. */
export {
...
// Hover primitives — keep full class names so Tailwind JIT can discover them
